...
服务器生成区块非常消耗资源，希望你服务器进行了预生成，如果没有进行的话请阅读 [预生成](https://yizhan.wiki/NitWikit/Java/optimize#第二步---预生成)
...
我们可以缩小生物刷新范围（以区块为单位，且不会大于[模拟距离](https://yizhan.wiki/NitWikit/Java/process/maintenance/optimize/go#手动调整)）从而获得和原版接近的密度。
...
这一项打开时候会大幅影响刷怪塔及游戏体验，因此 paper 为此做了[更加人性化的选项](https://yizhan.wiki/NitWikit/Java/process/maintenance/optimize/go#spawner-nerfed-mobs-should-jump)。
...
> 当 [Pufferfish's DAB](https://yizhan.wiki/NitWikit/Java/process/maintenance/optimize/go#dabenabled) 启用时，不建议修改该项任何默认值。
